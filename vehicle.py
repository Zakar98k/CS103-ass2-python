class Vehicle():
    ...
    def print_info(self):
        print(f"This {self.model if self.model else 'Vehicle'} is so fast it reaches speeds of {self.speed}kph. It has a {self.color} finish, and the license plate is {self.license_plate}")
